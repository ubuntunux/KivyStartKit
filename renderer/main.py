...
class Renderer(Widget):
    def __init__(self, **kwargs):
        ...
        self.canvas.shader.source = resource_find('renderer/simple.glsl')
        self.scene = ObjFile(resource_find("renderer/monkey.obj"))
...
class RendererApp(BaseApp, SingletonInstance):
    def __init__(self, app_name):
        super(RendererApp, self).__init__(app_name)
